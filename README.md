A simple quiz game application built with HTML, Tailwind CSS, and JavaScript. This app allows users to test their knowledge with a set of multiple-choice questions.
